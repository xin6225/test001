        ...
        <div id="post-body-content">
          ...
          <?php if (post_type_supports($post_type, 'title')) { ?>
            <div id="titlediv">
              <div id="titlewrap">
                ...
                <a href="#content" class="button-secondary screen-reader-text skiplink"
                   onclick="if (tinymce) { tinymce.execCommand( 'mceFocus', false, 'content' ); }"><?php esc_html_e('Skip to Editor'); ?></a>
              </div>
              <?php
              /**
          ...
          if (post_type_supports($post_type, 'editor')) {
            ...
            <div id="postdivrich" class="postarea<?php echo $_wp_editor_expand_class; ?>">
              ...
              ?>
              <table id="post-status-info" role="presentation">
                <tbody>
                <tr>
