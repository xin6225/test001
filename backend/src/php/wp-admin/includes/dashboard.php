...
function wp_dashboard_quick_press($error_msg = false)
{
  ...
  <form name="post" action="<?php echo esc_url(admin_url('post.php')); ?>" method="post" id="quick-press"
    ...
    <div class="textarea-wrap" id="description-wrap">
      ...
      <textarea name="content" id="content" placeholder="<?php esc_attr_e('What&#8217;s on your mind?'); ?>"
...
function _wp_dashboard_recent_comments_row(&$comment, $show_date = true)
{
  ...
  <li
    id="comment-<?php echo $comment->comment_ID; ?>" <?php comment_class(array('comment-item', wp_get_comment_status($comment)), $comment); ?>>
...
function wp_print_community_events_markup()
{
  ...
  <div id="community-events" class="community-events" aria-hidden="true">
    <div class="activity-block">
      ...
      <form class="community-events-form" aria-hidden="true"
        ...
        /* translators: Replace with a city related to your locale.
				 ...
				 */
        ?>
        <input id="community-events-location" class="regular-text" type="text" name="community-events-location"
  ...
  <div class="health-check-widget">
    <div class="health-check-widget-title-section site-health-progress-wrapper loading hide-if-no-js">
      <div class="site-health-progress">
        <svg aria-hidden="true" focusable="false" width="100%" height="100%" viewBox="0 0 200 200" version="1.1"
      ...
      <div class="welcome-panel-column">
        ...
        <div class="welcome-panel-column-content">
          <?php if ($is_block_theme) : ?>
            ...
            <a
              href="<?php echo esc_url(admin_url('/site-editor.php?path=%2Fwp_global_styles')); ?>"><?php _e('Edit styles'); ?></a>
          <?php else : ?>
            ...
            <a
              href="<?php echo esc_url(__('https://wordpress.org/documentation/article/block-themes/')); ?>"><?php _e('Learn about block themes'); ?></a>
          <?php endif; ?>
        </div>
      </div>
    </div>
