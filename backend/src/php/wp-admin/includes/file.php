...
function wp_print_file_editor_templates()
{
  ...
  <script type="text/html" id="tmpl-wp-file-editor-notice">
    <div
      class="notice inline notice-{{ data.type || 'info' }} {{ data.alt ? 'notice-alt' : '' }} {{ data.dismissible ? 'is-dismissible' : '' }} {{ data.classes || '' }}">
    ...
    <div id="request-filesystem-credentials-form" class="request-filesystem-credentials-form">
      ...
      <div class="ftp-password">
        <label for="password">
          ...
          <input name="password" type="password" id="password"
                 value="<?php echo $password_value; ?>"<?php disabled(defined('FTP_PASS')); ?> spellcheck="false"/>
          <?php
          if (!defined('FTP_PASS')) {
      ...
      if (isset($types['ssh'])) {
        ...
        <fieldset id="ssh-keys"<?php echo $hidden_class; ?>>
          ...
          <p
            id="auth-keys-desc"><?php _e('Enter the location on the server where the public and private keys are located. If a passphrase is needed, enter that in the password field above.'); ?></p>
        </fieldset>
        <?php
      }
