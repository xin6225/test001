    ...
    <div id="imgedit-panel-<?php echo $post_id; ?>">
      ...
      <div class="imgedit-panel-content imgedit-panel-tools wp-clearfix">
        <div class="imgedit-menu wp-clearfix">
          ...
          <button type="button" class="imgedit-scale button" onclick="imageEdit.toggleControls(this);"
                  aria-expanded="false" aria-controls="imgedit-scale"><?php esc_html_e('Scale'); ?></button>
          <div class="imgedit-rotate-menu-container">
            <button type="button" aria-controls="imgedit-rotate-menu" class="imgedit-rotate button"
                    aria-expanded="false" onclick="imageEdit.togglePopup(this)"
                    onblur="imageEdit.monitorPopup()"><?php esc_html_e('Image Rotation'); ?></button>
            <div id="imgedit-rotate-menu" class="imgedit-popup-menu">
              ...
              if (wp_image_editor_supports(
                ...
                $note_no_rotate = '';
                ?>
                <button type="button" class="imgedit-rleft button" onkeydown="imageEdit.browsePopup(event, this)"
                        onclick="imageEdit.rotate( 90, <?php echo "$post_id, '$nonce'"; ?>, this)"
                        onblur="imageEdit.monitorPopup()"><?php esc_html_e('Rotate 90&deg; left'); ?></button>
                <button type="button" class="imgedit-rright button" onkeydown="imageEdit.browsePopup(event, this)"
                        onclick="imageEdit.rotate(-90, <?php echo "$post_id, '$nonce'"; ?>, this)"
                        onblur="imageEdit.monitorPopup()"><?php esc_html_e('Rotate 90&deg; right'); ?></button>
                <button type="button" class="imgedit-rfull button" onkeydown="imageEdit.browsePopup(event, this)"
                        onclick="imageEdit.rotate(180, <?php echo "$post_id, '$nonce'"; ?>, this)"
                        onblur="imageEdit.monitorPopup()"><?php esc_html_e('Rotate 180&deg;'); ?></button>
                <?php
              } else {
              ...
              ?>
              <hr/>
              <button type="button" onkeydown="imageEdit.browsePopup(event, this)"
                      onclick="imageEdit.flip(1, <?php echo "$post_id, '$nonce'"; ?>, this)"
                      onblur="imageEdit.monitorPopup()"
        ...
        <div class="imgedit-submit imgedit-menu">
          ...
          <button type="button" onclick="imageEdit.save(<?php echo "$post_id, '$nonce'"; ?>)" disabled="disabled"
              ...
              <div id="imgedit-scale" tabindex="-1" class="imgedit-group-controls">
                <div class="imgedit-group-top">
                  ...
                  <button type="button" class="dashicons dashicons-editor-help imgedit-help-toggle"
                          onclick="imageEdit.toggleHelp(this);" aria-expanded="false"><span class="screen-reader-text">
						<?php
                    ...
                    <fieldset class="imgedit-scale-controls">
                      ...
                      <div class="nowrap">
                        ...
                        <input type="number" step="1" min="0"
                               ...
                               value="<?php echo isset($meta['height']) ? $meta['height'] : 0; ?>"/>
                        <button id="imgedit-scale-button" type="button"
              ...
              <div class="imgedit-group">
                <div class="imgedit-group-top">
                  ...
                  <div class="imgedit-help imgedit-restore">
                    ...
                    <div class="imgedit-submit">
                      <input type="button" onclick="imageEdit.action(<?php echo "$post_id, '$nonce'"; ?>, 'restore')"
              ...
              <div class="imgedit-thumbnail-preview-group">
                <figure class="imgedit-thumbnail-preview">
                  <img src="<?php echo $thumb['url']; ?>" width="<?php echo $thumb_img[0]; ?>"
                       height="<?php echo $thumb_img[1]; ?>" class="imgedit-size-preview" alt="" draggable="false"/>
