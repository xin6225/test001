    ...
    <table class="form-table" role="presentation">
      <tr>
        <th><label><input type="radio" name="subdomain_install"
                          value="1"<?php checked($subdomain_install); ?> /> <?php _e('Sub-domains'); ?></label></th>
        <td>
          <?php
          printf(
      ...
      <tr>
        <th><label><input type="radio" name="subdomain_install"
                          value="0"<?php checked(!$subdomain_install); ?> /> <?php _e('Sub-directories'); ?></label>
        </th>
        <td>
          <?php
          printf(
...
function network_step2($errors = false)
{
  ...
  <li><p id="network-wpconfig-rules-description">
    ...
    <textarea id="network-wpconfig-rules" class="code" readonly="readonly" cols="100" rows="7"
...
define( 'BLOG_ID_CURRENT_SITE', 1 );
    ...
    if (!empty($keys_salts)) {
      ...
      <p class="configuration-rules-label"><label
          for="network-wpconfig-authentication"><?php _e('Network configuration authentication keys'); ?></label></p>
      <textarea id="network-wpconfig-authentication" class="code" readonly="readonly" cols="100"
...
';
    ...
    <textarea id="network-webconfig-rules" class="code" readonly="readonly" cols="100" rows="20"
...
EOF;
    ...
    <textarea id="network-htaccess-rules" class="code" readonly="readonly" cols="100"
