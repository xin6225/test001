  ...
  <form method="post" action="settings.php" novalidate="novalidate">
    ...
    <table class="form-table" role="presentation">
      ...
      <tr>
        ...
        <td>
          <input name="new_admin_email" type="email" id="admin_email" aria-describedby="admin-email-desc"
      ...
      <tr>
        ...
        <td>
          ...
          <input name="illegal_names" type="text" id="illegal_names" aria-describedby="illegal-names-desc"
                 class="large-text" value="<?php echo esc_attr($illegal_names); ?>" size="45"/>
...
<?php echo esc_textarea($limited_email_domains); ?></textarea>
      ...
      <tr>
        ...
        <td>
          ...
          ?>
          <textarea name="banned_email_domains" id="banned_email_domains" aria-describedby="banned-email-domains-desc"
                    cols="45" rows="5">
...
<?php echo esc_textarea(get_site_option('welcome_email')); ?></textarea>
      ...
      <tr>
        ...
        <td>
					<textarea name="welcome_user_email" id="welcome_user_email" aria-describedby="welcome-user-email-desc"
                    rows="5" cols="45" class="large-text">
...
<?php echo esc_textarea(get_site_option('first_page')); ?></textarea>
      ...
      <tr>
        ...
        <td>
					<textarea name="first_comment" id="first_comment" aria-describedby="first-comment-desc" rows="5" cols="45"
                    class="large-text">
<?php echo esc_textarea(get_site_option('first_comment')); ?></textarea>
      ...
      <tr>
        ...
        <td>
          <input type="text" size="40" name="first_comment_email" id="first_comment_email"
    ...
    <table class="form-table" role="presentation">
      ...
      <tr>
        ...
        <td>
          <input name="upload_filetypes" type="text" id="upload_filetypes" aria-describedby="upload-filetypes-desc"
                 class="large-text"
                 value="<?php echo esc_attr(get_site_option('upload_filetypes', 'jpg jpeg png gif')); ?>" size="45"/>
    ...
    if (!empty($languages) || !empty($translations)) {
      ...
      <table class="form-table" role="presentation">
        <tr>
          <th><label for="WPLANG"><?php _e('Default Language'); ?><span class="dashicons dashicons-translation"
