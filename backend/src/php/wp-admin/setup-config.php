  ...
  <form method="post" action="setup-config.php?step=2">
    ...
    <table class="form-table" role="presentation">
      ...
      <tr>
        ...
        <td>
          <div class="wp-pwd">
            <input name="pwd" id="pwd" type="password" class="regular-text" data-reveal="1" aria-describedby="pwd-desc"
                   size="25"
                   placeholder="<?php echo htmlspecialchars(_x('password', 'example password'), ENT_QUOTES); ?>"
                   autocomplete="off" spellcheck="false"/>
            <button type="button" class="button pwd-toggle hide-if-no-js" data-toggle="0" data-start-masked="1"
      ...
      <tr>
        ...
        <td><input name="prefix" id="prefix" type="text" aria-describedby="prefix-desc" value="wp_" size="25"/>
          <p
            id="prefix-desc"><?php _e('If you want to run multiple WordPress installations in a single database, change this.'); ?></p>
        </td>
      </tr>
    </table>
    <?php
    ...
    <p class="step"><input name="submit" type="submit" value="<?php echo htmlspecialchars(__('Submit'), ENT_QUOTES); ?>"
...
?>
  ...
  <p class="step"><a href="<?php echo $install; ?>" class="button button-large"><?php _e('Run the installation'); ?></a>
  </p>
  <script>
    (function () {
