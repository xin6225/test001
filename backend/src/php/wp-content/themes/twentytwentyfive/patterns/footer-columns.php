      ...
      <div class="wp-block-group">
        ...
        <div class="wp-block-group" style="padding-right:0;padding-left:0">
          ...
          <h3 class="wp-block-heading has-medium-font-size"
              style="font-style:normal;font-weight:700"><?php esc_html_e('Stories', 'twentytwentyfive'); ?></h3>
          <!-- /wp:heading -->
        ...
        <div class="wp-block-group" style="padding-right:0;padding-left:0">
          <!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"medium"} -->
          <h3 class="wp-block-heading has-medium-font-size"
              style="font-style:normal;font-weight:700"><?php echo esc_html_x('Fleurs', 'Example brand name.', 'twentytwentyfive'); ?></h3>
          <!-- /wp:heading -->
          ...
          <!-- wp:navigation-link {"label":"<?php esc_html_e('Privacy', 'twentytwentyfive'); ?>","url":"#"} /-->
